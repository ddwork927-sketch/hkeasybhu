  ...
  */
  ...
  var WA_TEMPLATES = {
    '': '你好，我想查詢簡樸通服務。\n' +
        ...
        '4. 可以傳相片／影片嗎：\n' +
        '5. 方便聯絡時間：',
    a: '你好，我想查詢簡樸房約 HK$1,800 不包上門資料檢視。\n' +
       '1. 物業地區：\n' +
       '2. 大概有幾多個分間單位／房：\n' +
       '3. 我可以提供相片／租約／AR2／圖則作初步分流。\n' +
       '4. 我最擔心嘅事項：\n' +
       '5. 方便聯絡時間：',
    bhu_a: '你好，我想查詢簡樸房約 HK$1,800 不包上門資料檢視。\n' +
           '1. 物業地區：\n' +
           '2. 大概有幾多個分間單位／房：\n' +
           '3. 我可以提供相片／租約／AR2／圖則作初步分流。\n' +
           '4. 我最擔心嘅事項：\n' +
           '5. 方便聯絡時間：',
    b: '你好，我想查詢簡樸房約 HK$2,800 上門初步檢查。\n' +
       '1. 單位地區：\n' +
       '2. 大約有幾多間分間單位：\n' +
       '3. 現時有冇租約／AR2／圖則：\n' +
       '4. 可以傳相片或平面圖嗎：\n' +
       '5. 希望預約嘅時間：',
    bhu_b: '你好，我想查詢簡樸房約 HK$2,800 上門初步檢查。\n' +
           '1. 單位地區：\n' +
           '2. 大約有幾多間分間單位：\n' +
           '3. 現時有冇租約／AR2／圖則：\n' +
           '4. 可以傳相片或平面圖嗎：\n' +
    ...
    bhu: '你好，我想查詢簡樸房服務。\n' +
         '1. 物業地區：\n' +
         '2. 分間數量約：\n' +
         '3. 想問應該先做約 HK$1,800 資料檢視，定約 HK$2,800 上門初步檢查：\n' +
         '4. 可以傳相片／影片或租約／AR2 嗎：\n' +
         '5. 方便聯絡時間：',
    emergency: '你好，我想查詢 24 小時水電緊急維修。\n' +
               '1. 地區：\n' +
               '2. 問題：漏水／爆喉／跳掣／停電／焦味／火花／其他：\n' +
               '3. 已發生時間：\n' +
               '4. 目前情況（仍在漏水？已關水掣？全屋跳掣？局部無電？）：\n' +
               '5. 我會傳相片／短片俾你初步判斷。',
    maintenance: '你好，我想查詢日常水電維修。\n' +
                 '1. 地區：\n' +
                 '2. 問題：水龍頭／廁所水箱／燈掣插座／去水／其他：\n' +
                 '3. 方便預約時間：\n' +
                 '4. 我會傳相片俾你問價。'
  };
